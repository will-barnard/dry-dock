...
class SiteLearningJob(Base):
    """One agent-assisted recipe-learning attempt for a site (Phase B). Fetch
    a sample page → model proposes a recipe → validate → save. Status is a
    plain string ('pending'|'running'|'done'|'error') to avoid coupling to
    another enum type."""

    __tablename__ = "site_learning_jobs"
